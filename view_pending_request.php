...
<?php require('topbar.php'); ?>
        ...
        if(isset($_SESSION['message'])){?>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">All Pending Request<p style="font-size: 1rem;">(Waiting for your confirmation)</p></h1>
          </div>
...
<!-- Get All Relatives -->
          ...
          <?php  $getAllFriends = mysqli_query($mysqli, " SELECT *
                  FROM users
                  WHERE id IN (SELECT from_user_id FROM user_links WHERE to_user_id = '$user_id' AND linked = 'false') ");
